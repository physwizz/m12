...
/*Overclocking little cores to 2.6GHz*/
static unsigned long arg_cpu_max_c1 = 2210000; /*max_cpu_freq=2.2GHz for little cores*/
...
unsigned long arg_cpu_max_c2 = 2210000; /*max_cpu_freq=2.2GHz*/
